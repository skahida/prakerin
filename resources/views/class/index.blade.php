        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ isset($class) ? route('class.update', $class->code) : route('class.store') }}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" class="form-control"
                                                value="{{ old('code', isset($class) ? $class->code : '') }}"
                                                placeholder="Masukan Kode Kelas" autofocus
                                ...
                                <button type="submit" class="btn btn-info btn-fill">
                                    <i class="fa {{ isset($class) ? 'fa-edit' : 'fa-save' }}"></i>
                                    {{ isset($class) ? 'Ubah' : 'Simpan' }}
                                </button>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-3">Cari Data Kelas</h4>
                            <form method="GET">
                                <label>Kelas:</label>
                                <div class="form-group">
                                    <input type="text" name="search" class="form-control"
                                        placeholder="Search by Nama Kelas" value="{{ $search }}">
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append ml-2"> <!-- Added margin-left (ml-2) to create space -->
                                        <a href="{{ route('class') }}" class="btn btn-md btn-primary btn-fill">
                    ...
                    <div class="card strpied-tabled-with-hover">
                        ...
                        <div class="card-body table-full-width table-responsive">
                                ...
                                <tbody>
                                    @foreach ($classes as $class)
                                        <tr>
                                            ...
                                            <td>{{ $class->name }}</td>
                                            <td>
                                                <a href="{{ route('class.edit', $class->code) }}"
                            ...
                            <div class="pagination justify-content-center">
                                ...
                                {{ $classes->appends(['search' => $search])->links('pagination::bootstrap-4') }}
