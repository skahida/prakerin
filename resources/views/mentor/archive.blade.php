...
@section('title', 'Arsip Guru Pembimbing — Tera Prakerin')
    ...
    <div class="max-w-7xl mx-auto space-y-10">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 font-medium mt-1 uppercase tracking-wider">
                            Cari akun guru pembimbing berdasarkan nama
                        </p>
                    </div>
                            ...
                            <select name="search" id="search" class="select2-dropdown w-full">
                                ...
                                @foreach ($mentorAll as $mentor)
                                    <option value="{{ $mentor->name }}"
                                        {{ request('search') == $mentor->name ? 'selected' : '' }}>
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 font-medium mt-1 uppercase tracking-wider">
                            Daftar akun guru pembimbing yang telah diarsipkan
                        </p>
                    </div>
                    ...
                    <div
                        class="w-11 h-11 shrink-0 rounded-2xl
                            ...
                            justify-center border border-purple-100">
                ...
                @if ($mentors->isEmpty())
                    ...
                    <div class="text-center py-24 px-6">
                        ...
                        <p class="text-slate-400 font-medium max-w-md mx-auto mt-2">
                            Tidak ada akun guru pembimbing yang dinonaktifkan atau
                            ...
                            <tbody class="divide-y divide-slate-50">
                                @foreach ($mentors as $mentor)
                                    @php
                                        ...
                                        $initial = mb_strtoupper(mb_substr($mentorName, 0, 1));
                                    @endphp
        ...
        @else
            ...
            <div
                ...
                <p class="text-slate-400 font-medium max-w-md mx-auto mt-2">
                    Halaman arsip guru pembimbing hanya dapat diakses oleh admin.
                </p>
            </div>
        @endif
    </div>
