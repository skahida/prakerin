                    ...
                    <div class="card-body">
                        ...
                        <form id="monitoring-form" action="{{ route('monitoring.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" class="form-control form-control-lg selectpicker required">
                            </div>

                            <div class="form-group mt-3">
                                <label>Bukti Foto</label>
                                <input type="file" name="monitor_photo" class="form-control" accept="image/*" onchange="previewImage(event)">
                                <small class="form-text text-muted">Upload foto kunjungan (bisa pilih kamera atau galeri)</small>
                            </div>
